...
if (isset($_POST['submit'])) {
    $updateQuery = "UPDATE employee,bankinfo set employee.status = 'A' , bankinfo.status = 'A'  WHERE employee.employeeId = bankinfo.employeeId and employee.status = 'I' and bankinfo.status = 'I' and employee.companyId = $companyID";
...
if (isset($_POST['reject'])) {
    $updateQuery = "UPDATE employee,bankinfo set employee.status = 'R' , bankinfo.status = 'R'  WHERE employee.employeeId = bankinfo.employeeId and employee.status = 'I' and bankinfo.status = 'I' and employee.companyId = $companyID";
    if (mysqli_query($con, $updateQuery)) {
