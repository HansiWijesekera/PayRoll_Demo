        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <table id="tblUser">
                    ...
                    <tbody>
                        <?php
                        $selectQuery = "select * from salary_advance inner join employee on salary_advance.employeeId = employee.EmployeeId  where employee.companyId  = $companyID and salary_advance.status = 'A' ";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="advancePayment.php?id=<?php echo $advanceId; ?>" class="btn btn-primary btn-sm">Pay Advance</a>
                                </td>
                            </tr>
                        <?php
                        }
